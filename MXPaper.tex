...
\begin{figure}
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\textwidth, height = 1.5in]{Figures/Upload_Raw.png}
		\subcaption{}
		\label{fig:FigUpload}
	\end{subfigure}	\hfill
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\textwidth, height = 1.5in]{Figures/Heatmap_Raw.png}
		\subcaption{}
		\label{fig:FigHeatmap}
	\end{subfigure}	
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\textwidth, height = 1.5in]{Figures/Sample_Raw.png}
		\subcaption{}
		\label{fig:FigSample}
	\end{subfigure} \hfill
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\textwidth, height = 1.5in]{Figures/Outliers_Raw.png}
		\subcaption{}
		\label{fig:FigOutliers}
	\end{subfigure}
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\textwidth, height = 1.5in]{Figures/Correlation_Raw.png}
		\subcaption{}
		\label{fig:FigCorrelation}
	\end{subfigure}\hfill
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\textwidth, height = 1.5in]{Figures/Feature_Raw.png}
		\subcaption{}
		\label{fig:FigFeature}
	\end{subfigure}
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\textwidth, height = 1.5in]{Figures/Embedding_Raw.png}
		\subcaption{}
