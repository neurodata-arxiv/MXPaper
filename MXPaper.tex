...
\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth]{Figures/Upload_Raw.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth]{Figures/Heatmap_Raw.png}
	\caption{Heatmap of data with various normalization options.}
	\label{fig:FigHeatmap}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth]{Figures/Sample_Raw.png}
	\caption{Marginal distributions of individual features.}
	\label{fig:FigSample}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth]{Figures/Outliers_Raw.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth]{Figures/Correlation_Raw.png}
	\caption{Pearson's correlation between features.}
	\label{fig:FigCorrelation}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth]{Figures/Feature_Raw.png}
	\caption{Marginal distributions of all features on a single plot.}
	\label{fig:FigFeature}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth]{Figures/Embedding_Raw.png}
