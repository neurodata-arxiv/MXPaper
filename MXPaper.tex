...
\begin{figure}
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\textwidth]{Figures/Upload_Raw.png}
		\subcaption{}
		\label{fig:FigUpload}
	\end{subfigure}	\hfill
	\begin{subfigure}[b]{0.45\textwidth}
	...
	\end{subfigure}	
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\textwidth]{Figures/Sample_Raw.png}
		\subcaption{}
		\label{fig:FigSample}
	\end{subfigure} \hfill
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\textwidth]{Figures/Outliers_Raw.png}
		\subcaption{}
		\label{fig:FigOutliers}
	\end{subfigure}
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\textwidth]{Figures/Correlation_Raw.png}
		\subcaption{}
		\label{fig:FigCorrelation}
	\end{subfigure}\hfill
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\textwidth]{Figures/Feature_Raw.png}
		\subcaption{}
		\label{fig:FigFeature}
	\end{subfigure}
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\textwidth]{Figures/Embedding_Raw.png}
		\subcaption{}
